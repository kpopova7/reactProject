  ...
  return <div className="home">
    ...
    <section className="home-cards">
      <div>
        ...
        <button className="glow-on-hover">Learn More <i className="fas fa-chevron-right"></i></button>
      </div>
      <div>
          ...
          <button className="glow-on-hover">
			...
			<section className="home-cards">
				<div>
					...
					<button className="glow-on-hover">Shop Now <i className="fas fa-chevron-right"></i></button>
				</div>
				<div>
				...
				<div>
					...
					<button className="glow-on-hover">Download Now <i className="fas fa-chevron-right"></i></button>
				</div>
				<div>
					...
					<button className="glow-on-hover">Get Started <i className="fas fa-chevron-right"></i></button>
				</div>
      </section>
